...
lxc network create incusbr1
lxc network create incusbr2
lxc network create incusbr3
...
incus launch $OS:$VER vm1 --vm -n incusbr1
incus launch $OS:$VER vm2 --vm -n incusbr2
incus launch $OS:$VER vm3 --vm -n incusbr3
